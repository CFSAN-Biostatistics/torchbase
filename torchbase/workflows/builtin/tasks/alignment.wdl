...
# Alias task for compatibility with test expectations
...
# Main
query_seqs = parse_fasta("~{query}")
preset = "~{preset}"

alignment_results = run_minimap2_alignment(query_seqs, "~{reference}", preset)
